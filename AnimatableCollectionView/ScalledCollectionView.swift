...
public typealias CurrentScaleBlock = ((_ currentCell : UICollectionViewCell, _ currentScale: CGFloat,_ maxScale: CGFloat, _ minScale: CGFloat) -> ())
...
open class ScaledVisibleCellsCollectionView {
    ...
    var currentScaleBlock : CurrentScaleBlock?
}
...
extension UICollectionView {
    ...
    public func setScaledDesginParam(scaledPattern pattern: SC_ScaledPattern, maxScale: CGFloat, minScale: CGFloat, maxAlpha: CGFloat, minAlpha: CGFloat, currentCellScaleBlock: CurrentScaleBlock?) {
        ScaledVisibleCellsCollectionView.sharedInstance.scaledPattern = pattern
        ScaledVisibleCellsCollectionView.sharedInstance.maxScale = maxScale
        ScaledVisibleCellsCollectionView.sharedInstance.minScale = minScale
        ScaledVisibleCellsCollectionView.sharedInstance.maxAlpha = maxAlpha
        ScaledVisibleCellsCollectionView.sharedInstance.minAlpha = minAlpha
        ScaledVisibleCellsCollectionView.sharedInstance.currentScaleBlock = currentCellScaleBlock
...
extension UICollectionView {
    ...
    fileprivate func scaleCellsForHorizontalScroll(_ visibleCells: [UICollectionViewCell]) {
        ...
        for cell in visibleCells  {
            ...
            // notify callback
            if let callback = ScaledVisibleCellsCollectionView.sharedInstance.currentScaleBlock {
                callback(cell, preferredScale,ScaledVisibleCellsCollectionView.sharedInstance.maxScale,ScaledVisibleCellsCollectionView.sharedInstance.minScale)
            }
